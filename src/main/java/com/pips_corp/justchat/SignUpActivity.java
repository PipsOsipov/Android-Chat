...
import com.pips_corp.justchat.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
                ...
                if (result.getResultCode() == RESULT_OK){
                    if (result.getData() != null){
                        ...
                        try {
                            ...
                            encodingImage = encodeImage(bitmap);
    ...
    private Boolean isValidSignUpDetils(){
        if (encodingImage == null){
            ...
            return false;
        } else if (!binding.ConfirmPassword.getText().toString().equals(binding.ConfirmPassword.getText().toString())) {
